    ...
    children: [
      {
        path: "/setting",
        name: "setup",
        meta: { title: "setup", group: "setup", icon: "dashboard" },
        component: () => import(/* webpackChunkName: "dashboard" */ "@/views/admin/settings/setup.vue")
      },
      {
        path: "/menu",
        name: "menu",
        component: DefaultLayout,
        meta: { title: "menu", group: "menu", icon: "dashboard" },
        component: () => import(/* webpackChunkName: "dashboard" */ "@/views/admin/settings/menu.vue")
      },
      {
        path: "/403",
        name: "Forbidden",
